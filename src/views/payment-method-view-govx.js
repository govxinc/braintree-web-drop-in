...
var paymentMethodHTML = fs.readFileSync(
  __dirname + "/../html/payment-method-govx.html",
  "utf8"
);
  ...
  switch (this.paymentMethod.type) {
    ...
    case paymentMethodTypes.card:
      ...
      html = html
        .replace(
          /@ICON/g,
          "icon-" + paymentMethodCardTypes[this.paymentMethod.details.cardType]
        )
...
PaymentMethodView.prototype._choosePaymentMethod = function () {
  if (this.paymentMethod.vaulted) {
    analytics.sendEvent(
      this.client,
      "vaulted-" + constants.analyticsKinds[this.paymentMethod.type] + ".select"
    );
  }
