...
MainView.prototype.toggleAdditionalOptions = function () {
  var sheetViewID;
  var isPaymentSheetView =
    this.paymentSheetViewIDs.indexOf(this.primaryView.ID) !== -1;
...
MainView.prototype.teardown = function () {
  ...
  var teardownPromises = viewNames.map(
    function (view) {
...
MainView.prototype.openConfirmPaymentMethodDeletionDialog = function (
  paymentMethod
) {
...
MainView.prototype._sendToDefaultView = function () {
  ...
  var preselectVaultedPaymentMethod =
